...
public class WriteTransactionButton extends JButton{
    
    public WriteTransactionButton(String text){
        ...
        this.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {     
                WriteTransactionGUI writeTransactionGUI = new WriteTransactionGUI();
            }
        });
